...
modules/tracking/CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.o: /root/iopencv/opencv_contrib/modules/tracking/samples/multitracker.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/iopencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object modules/tracking/CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.o"
	cd /root/iopencv/opencv/build/modules/tracking && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.o -c /root/iopencv/opencv_contrib/modules/tracking/samples/multitracker.cpp
...
modules/tracking/CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.i: cmake_force
	...
	cd /root/iopencv/opencv/build/modules/tracking && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/iopencv/opencv_contrib/modules/tracking/samples/multitracker.cpp > CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.i
...
modules/tracking/CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.s: cmake_force
	...
	cd /root/iopencv/opencv/build/modules/tracking && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/iopencv/opencv_contrib/modules/tracking/samples/multitracker.cpp -o CMakeFiles/example_tracking_multitracker.dir/samples/multitracker.cpp.s
...
bin/example_tracking_multitracker: lib/libopencv_tracking.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_plot.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_datasets.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_video.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_highgui.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_text.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_ml.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_videoio.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_imgcodecs.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_dnn.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_calib3d.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_features2d.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_flann.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_imgproc.so.4.5.2
bin/example_tracking_multitracker: lib/libopencv_core.so.4.5.2
bin/example_tracking_multitracker: modules/tracking/CMakeFiles/example_tracking_multitracker.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/iopencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tracking_multitracker"
	cd /root/iopencv/opencv/build/modules/tracking && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tracking_multitracker.dir/link.txt --verbose=$(VERBOSE)
...
modules/tracking/CMakeFiles/example_tracking_multitracker.dir/clean:
	cd /root/iopencv/opencv/build/modules/tracking && $(CMAKE_COMMAND) -P CMakeFiles/example_tracking_multitracker.dir/cmake_clean.cmake
...
modules/tracking/CMakeFiles/example_tracking_multitracker.dir/depend:
	cd /root/iopencv/opencv/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/iopencv/opencv /root/iopencv/opencv_contrib/modules/tracking /root/iopencv/opencv/build /root/iopencv/opencv/build/modules/tracking /root/iopencv/opencv/build/modules/tracking/CMakeFiles/example_tracking_multitracker.dir/DependInfo.cmake --color=$(COLOR)
