...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o: ../samples/cpp/tutorial_code/video/bg_sub.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/root/iopencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o"
	cd /root/iopencv/opencv/build/samples/cpp && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.o -c /root/iopencv/opencv/samples/cpp/tutorial_code/video/bg_sub.cpp
...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.i: cmake_force
	...
	cd /root/iopencv/opencv/build/samples/cpp && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /root/iopencv/opencv/samples/cpp/tutorial_code/video/bg_sub.cpp > CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.i
...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.s: cmake_force
	...
	cd /root/iopencv/opencv/build/samples/cpp && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /root/iopencv/opencv/samples/cpp/tutorial_code/video/bg_sub.cpp -o CMakeFiles/example_tutorial_bg_sub.dir/tutorial_code/video/bg_sub.cpp.s
...
bin/example_tutorial_bg_sub: lib/libopencv_aruco.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_bgsegm.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_bioinspired.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_ccalib.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_dnn_objdetect.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_dnn_superres.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_dpm.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_face.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_freetype.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_fuzzy.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_hfs.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_img_hash.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_intensity_transform.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_line_descriptor.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_mcc.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_quality.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_rapid.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_reg.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_rgbd.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_saliency.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_stereo.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_structured_light.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_superres.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_surface_matching.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_tracking.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_videostab.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_wechat_qrcode.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_xfeatures2d.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_xobjdetect.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_xphoto.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_shape.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_highgui.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_datasets.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_plot.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_text.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_ml.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_phase_unwrapping.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_optflow.so.4.5.2
bin/example_tutorial_bg_sub: lib/libopencv_ximgproc.so.4.5.2
...
bin/example_tutorial_bg_sub: samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/root/iopencv/opencv/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_bg_sub"
	cd /root/iopencv/opencv/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_bg_sub.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/clean:
	cd /root/iopencv/opencv/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_tutorial_bg_sub.dir/cmake_clean.cmake
.PHONY : samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/clean

samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/depend:
	cd /root/iopencv/opencv/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /root/iopencv/opencv /root/iopencv/opencv/samples/cpp /root/iopencv/opencv/build /root/iopencv/opencv/build/samples/cpp /root/iopencv/opencv/build/samples/cpp/CMakeFiles/example_tutorial_bg_sub.dir/DependInfo.cmake --color=$(COLOR)
